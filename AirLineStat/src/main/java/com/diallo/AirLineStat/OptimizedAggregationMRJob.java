...
public class OptimizedAggregationMRJob extends Configured implements Tool 
{
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(OptimizedAggregationMRJob.class);
	...
	public static void main(String[] args) throws Exception {
		...
		ToolRunner.run(new OptimizedAggregationMRJob(), args);
	}
